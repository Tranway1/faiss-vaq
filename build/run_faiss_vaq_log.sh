...
VAQ_DATASET_PATH=/local/chunwei/ikra/faiss/build/enc
...
if [ "$2" = "ASTRO" ]; then
  ...
  run_basic 32 $DATASET_SIZE 100 $INDEX\
    $VAQ_DATASET_PATH/ASTRO1M_VAQ256m32min4max10var1,EA_TI2000_1000000_32.bin $VAQ_DATASET_PATH/ASTRO1M_VAQ256m32min4max10var1,EA_TI2000_query_100_32.bin\
    "answer/VAQ_ASTRO_${DATASET_SIZE_H}_${INDEX}.csv" 100 $LOGFILE
elif [ "$2" = "SEISMIC" ]; then
  if [ "$3" = "100M" ]; then
  ...
  run_basic 32 $DATASET_SIZE 100 $INDEX\
    $VAQ_DATASET_PATH/SEISMIC1M_VAQ256m32min7max13var1,EA_TI2000_1000000_32.bin $VAQ_DATASET_PATH/SEISMIC1M_VAQ256m32min7max13var1,EA_TI2000_query_100_32.bin\
    "answer/SEISMIC_${DATASET_SIZE_H}_${INDEX}.csv" 100 $LOGFILE
elif [ "$2" = "SALD" ]; then
  if [ "$3" = "100M" ]; then
    DATASET_SIZE=100000000; DATASET_SIZE_H=100M
  elif [ "$3" = "1M" ]; then
  ...
  run_basic 64 $DATASET_SIZE 100 $INDEX\
    $VAQ_DATASET_PATH/SALD1M_VAQ256m64min1max9var1,EA_TI2000_1000000_64.bin $VAQ_DATASET_PATH/SALD1M_VAQ256m64min1max9var1,EA_TI2000_query_100_64.bin\
    "answer/SALD_${DATASET_SIZE_H}_${INDEX}.csv" 100 $LOGFILE
elif [ "$2" = "DEEP" ]; then
  if [ "$3" = "100M" ]; then
    DATASET_SIZE=100000000; DATASET_SIZE_H=100M
  elif [ "$3" = "1M" ]; then
  ...
  run_basic 64 $DATASET_SIZE 100 $INDEX\
    $VAQ_DATASET_PATH/DEEP1M_VAQ256m64min1max7var1,EA_TI2000_1000000_64.bin $VAQ_DATASET_PATH/DEEP1M_VAQ256m64min1max7var1,EA_TI2000_query_100_64.bin\
    "answer/DEEP_${DATASET_SIZE_H}_${INDEX}.csv" 100 $LOGFILE
elif [ "$2" = "SIFT" ]; then
  if [ "$3" = "100M" ]; then
    DATASET_SIZE=100000000; DATASET_SIZE_H=100M
  elif [ "$3" = "1M" ]; then
