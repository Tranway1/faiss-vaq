...
python3 extract.py log_base/SIFT${DSIZE}_${INDEX}_efc${EFC}efs${EFS}.txt >> extract-runtime.txt
python3 extract.py log_base/SEISMIC${DSIZE}_${INDEX}_efc${EFC}efs${EFS}.txt  >> extract-runtime.txt
python3 extract.py log_base/SALD${DSIZE}_${INDEX}_efc${EFC}efs${EFS}.txt >> extract-runtime.txt
python3 extract.py log_base/DEEP${DSIZE}_${INDEX}_efc${EFC}efs${EFS}.txt >> extract-runtime.txt
python3 extract.py log_base/ASTRO${DSIZE}_${INDEX}_efc${EFC}efs${EFS}.txt >> extract-runtime.txt
