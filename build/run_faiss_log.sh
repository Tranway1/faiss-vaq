...
ASTRO_DATASET_PATH=/tank/local/chunwei/dataset/ASTRO
SEISMIC_DATASET_PATH=/tank/local/chunwei/dataset/SEISMIC
SALD_DATASET_PATH=/tank/local/chunwei/dataset/SALD
DEEP1B_DATASET_PATH=/tank/local/chunwei/dataset/DEEP1B
SIFT1B_DATASET_PATH=/tank/local/chunwei/dataset/SIFT1B
GIST_DATASET_PATH=/tank/local/chunwei/dataset/GIST
GLOVE_DATASET_PATH=/tank/local/chunwei/dataset/GLOVE
...
NNSBENCH_PATH=/tank/local/chunwei/dataset/NNS_BENCH

# ANN-Benchmark datasets
# FASHION, LASTFM, NYTIMES
ANNBENCH_PATH=/tank/local/chunwei/dataset/ANN_BENCH
# AUDIO, ENRON, IMAGENET, MNIST, MSONG, NOTRE,
# NUSW, SUN397, TREVI, UKBENCH
